...
<head>
    ...
    <meta name="description" content="Sistem Absensi Karyawan Online Berbasis GPS" />
                    ...
                    <div class="card-body">
                        <div class="app-brand justify-content-center mb-4">
                            <a href="{{ url('/') }}" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">Absensi Karyawan</span>
                            </a>
                        </div>
                        ...
                        {{-- ======================================================= --}}
                        {{-- ✅ BLOK NOTIFIKASI ERROR DITAMBAHKAN DI SINI ✅ --}}
                        {{-- ======================================================= --}}
                        @if ($errors->any())
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('login') is-invalid @enderror" id="login"
                                    name="login" value="{{ old('login') }}" placeholder="Masukkan Email atau NIP Anda"
                                    autofocus required />

                                {{-- Kode @error di bawah ini tetap dipertahankan untuk border merah --}}
                                @error('login')
